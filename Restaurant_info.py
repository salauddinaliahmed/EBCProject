...
while True:
    ...
    for each_entity in each_block:
        ...
        if title == None:
            ...
            rest_link.append("https://www.tripadvisor.ca"+ str(title.get('href')))
...
print ("Length of names",len(rest_name))
print ("Length of links",len(rest_link))
print ("Length of rating",len(rest_reviews))
print ("Length of reviews",len(rest_reviews))
print ("Length of offering",len(rest_offering))
print ("Length of pricing",len(rest_pricing))

df_rest = pd.DataFrame({'Restaurant_name':rest_name, 'Restaurant_link': rest_link, 'Restaurant_rating': rest_rating, 'Restaurant_reviews': rest_reviews, 'Restaurant_offering': rest_offering, 'Restaurant_pricing': rest_pricing})
df_rest.to_csv('/Users/salauddinali/Desktop/test_reviews.csv')
